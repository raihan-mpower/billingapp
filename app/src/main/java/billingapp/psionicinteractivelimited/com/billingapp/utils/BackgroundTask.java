    ...
    protected String doInBackground(String... params) {
        ...
        Log.v("IN BACKGROUND:TOKEN",sync_url);
            ...
            try {
                ...
                String data =
                                URLEncoder.encode("customer_id", "UTF-8") + "=" + URLEncoder.encode(customer.getCustomers_id(), "UTF-8") + "&" +
                        ...
                        Log.v(""+customer.getCustomers_id(),""+customer.get_to_sync_total_amount()+" "+customer.get_to_sync_total_amount()+" "+customer.get_to_sync_collection_date()+" "+customer.get_to_sync_lat()+" "+customer.get_to_sync_lon());
